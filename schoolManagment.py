...
class Password:
    ...
    def __init__(self,root):
        ...
        m_title = Label(Manage_Frame,text="Change Password",bg="#F0EDEE",fg="#0A090C",font=("Arial",30,"bold","italic"))

        m_title.grid(row = 0,columnspan=2,pady=20,padx=450)

        
        lbl_username = Label(Manage_Frame,text="Username -",bg="#F0EDEE",fg="#0A090C",font=("Arial",15,"bold"))
        lbl_username.grid(row = 1,column=0,pady=10,padx=500)

    

        txt_dept_id = Entry(Manage_Frame,textvariable=self.username,font=("Arial",15,"bold"),bd=5,relief=GROOVE)
        txt_dept_id.grid(row = 2,column=0,pady=10,padx=500)

        

        lbl_name = Label(Manage_Frame,text="Old Password -",bg="#F0EDEE",fg="#0A090C",font=("Arial",15,"bold"))
        lbl_name.grid(row = 3,column=0,pady=10,padx=500)

    

        txt_name = Entry(Manage_Frame,show="*",textvariable=self.old_password,font=("Arial",15,"bold"),bd=5,relief=GROOVE)
        txt_name.grid(row = 4,column=0,pady=10,padx=500)

        

        lbl_name = Label(Manage_Frame,text="New Password -",bg="#F0EDEE",fg="#0A090C",font=("Arial",15,"bold"))
        lbl_name.grid(row = 5,column=0,pady=10,padx=500)

    

        txt_name = Entry(Manage_Frame,show="*",textvariable=self.new_password,font=("Arial",15,"bold"),bd=5,relief=GROOVE)
    ...
    def change_pass(self):
        ...
        if self.username.get() == "" or self.old_password.get() == "" or self.new_password.get() == "":
            ...
            connect = pymysql.connect(host="localhost", user="root", password="14127@RAO", database="rdbmss")
            curr = connect.cursor()
...
class Department:
    ...
    def update(self):
        ...
        if self.dept_id.get() == "" or self.dept_name.get() == "":
            ...
            pymysql.connect(host="localhost", user="root", password="14127@RAO", database="rdbmss")
            curr = connect.cursor()
...
class Employee:
    ...
    def __init__(self,root):
        ...
        m_title = Label(Manage_Frame,text="Manage Employees",bg="#F0EDEE",fg="#0A090C",font=("Arial",30,"bold","italic"))
        m_title.grid(row = 0,columnspan=2,pady=20)

        

        lbl_roll = Label(Manage_Frame,text="Emp ID.",bg="#F0EDEE",fg="black",font=("Arial",15,"bold"))
        lbl_roll.grid(row = 1,column=0,pady=10,padx=20,sticky="w")

    

        txt_Roll = Entry(Manage_Frame,textvariable=self.emp_id,font=("Arial",15,"bold"),bd=5,relief=GROOVE)
        txt_Roll.grid(row = 1,column=1,pady=10,padx=20,sticky="w")

        

        lbl_name = Label(Manage_Frame,text="Name.",bg="#F0EDEE",fg="black",font=("Arial",15,"bold"))
        lbl_name.grid(row = 2,column=0,pady=10,padx=20,sticky="w")

    

        txt_name = Entry(Manage_Frame,textvariable=self.ename,font=("Arial",15,"bold"),bd=5,relief=GROOVE)
        txt_name.grid(row = 2,column=1,pady=10,padx=20,sticky="w")

        

        lbl_email = Label(Manage_Frame,text="Email-ID.",bg="#F0EDEE",fg="black",font=("Arial",15,"bold"))
        lbl_email.grid(row = 3,column=0,pady=10,padx=20,sticky="w")

    

        txt_email = Entry(Manage_Frame,textvariable=self.email_id,font=("Arial",15,"bold"),bd=5,relief=GROOVE)
        txt_email.grid(row = 3,column=1,pady=10,padx=20,sticky="w")

        

        lbl_contact = Label(Manage_Frame,text="Contact",bg="#F0EDEE",fg="black",font=("Arial",15,"bold"))
        lbl_contact.grid(row = 4,column=0,pady=10,padx=20,sticky="w")

    

        txt_contact = Entry(Manage_Frame,textvariable=self.contact,font=("Arial",15,"bold"),bd=5,relief=GROOVE)
        txt_contact.grid(row = 4,column=1,pady=10,padx=20,sticky="w")

        

        lbl_Dept = Label(Manage_Frame,text="Dept No",bg="#F0EDEE",fg="black", font=("Arial",15,"bold"))
        lbl_Dept.grid(row = 5,column=0,pady=10,padx=20,sticky="w")

    

        txt_dept = Entry(Manage_Frame,textvariable=self.dept,font=("Arial",15,"bold"),bd=5,relief=GROOVE)
        txt_dept.grid(row = 5,column=1,pady=10,padx=20,sticky="w")


        lbl_position = Label(Manage_Frame,text="Position",bg="#F0EDEE",fg="black",font=("Arial",15,"bold"))
        lbl_position.grid(row = 6,column=0,pady=10,padx=20,sticky="w")

    

        txt_dept = Entry(Manage_Frame,textvariable=self.position,font=("Arial",15,"bold"),bd=5,relief=GROOVE)
        txt_dept.grid(row = 6,column=1,pady=10,padx=20,sticky="w")        

        

        lbl_address = Label(Manage_Frame,text="Address",bg="#F0EDEE",fg="black",font=("Arial",15,"bold"))
    ...
    def update(self):
        ...
        if self.emp_id.get() == "" or self.ename.get() == "" or self.email_id.get() == ""or self.position.get()== "" or self.dept.get()== ""or self.contact.get() == "" or self.txt_address.get('1.0',END) == "":
            ...
            curr.execute("UPDATE EMPLOYEE SET dept_id=%s,ename=%s,email_id=%s,address=%s,contact_no=%s,position=%s where emp_id=%s",(self.dept.get(), self.ename.get(),self.email_id.get(), self.txt_address.get('1.0',END), self.contact.get(),self.position.get(),  self.emp_id.get()                                                                                                                           ))
...
class Student:
    ...
    def __init__(self,root):
        ...
        lbl_roll = Label(Manage_Frame,text="Roll No.",bg="#F0EDEE",fg="black",font=("Arial",15,"bold"))
        lbl_roll.grid(row = 1,column=0,pady=10,padx=20,sticky="w")
        ...
        font=("Arial",10,"bold"),relief=GROOVE,width=10,pady=5,command=self.search_data).grid(row=0,column=5,padx=10,pady=10)
